...
export class ParticipantesPage implements OnInit {
  ...
  public participantesBase: IParticipantes[] = [
    {
      "ID": 1,
  ...
  public get participanteActivo(){
    return this.participantesBase.filter(par => par.Estado === true);
  }
  public get participanteInactivo(){
    return this.participantesBase.filter(par => par.Estado === false);
  }
